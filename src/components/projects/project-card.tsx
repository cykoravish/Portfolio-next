...
export default function ProjectCard(props: ProjectCardProps) {
  return (
    <motion.div
      ...
      className="w-full overflow-hidden rounded-lg border border-accent/20 bg-background shadow-md transition-shadow duration-150 hover:shadow-md hover:shadow-accent/20 dark:bg-zinc-800 dark:hover:shadow-lg lg:max-w-[600px]"
    >
